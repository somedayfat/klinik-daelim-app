                    ...
                    <div class="page-title">
                        <div class="row">
                            <div class="col-12 col-md-6 order-md-1 order-last">
                                <h3>Data Karyawan</h3>
                                <p class="text-subtitle text-muted">Data Karyawan Kontrak & Tetap <strong>PT. Daelim Indonesia</strong></p>
                            </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $tgl_masuk; ?></td>
                                                        <td>
                                                            <span class="badge <?= $badge_class ?> badge-status">
                                                                <?= $data['status']; ?>
                                                            </span>
                                                        </td>
                                                        <td>
                                                            <div class="btn-group-action">
                                                                <a href="edit.php?id=<?= $data['id_card']; ?>" 
                                            ...
                                            <?php
                                                ...
                                                echo '<tr><td colspan="11" class="text-center">Belum ada data karyawan</td></tr>';
                                            }
                                            ?>
                                        </tbody>
                                    </table>
