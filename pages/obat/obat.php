...
<head>
  ...
  <!-- Custom CSS untuk tabel -->
    <style>
        ...
        /* Kolom ID Card, Jekel, Status lebih kecil */
        #table1 thead th:nth-child(2),
        #table1 tbody td:nth-child(2),
        #table1 thead th:nth-child(7),
        #table1 tbody td:nth-child(7),
        #table1 thead th:nth-child(10),
        #table1 tbody td:nth-child(10) {
            width: 80px !important;
            text-align: center !important;
        }
        
        /* Kolom Tanggal */
        #table1 thead th:nth-child(6),
        #table1 tbody td:nth-child(6),
        #table1 thead th:nth-child(9),
        #table1 tbody td:nth-child(9) {
            width: 100px !important;
            text-align: center !important;
        }
        
        /* Button group lebih compact */
        .btn-group-action {
            display: flex;
            gap: 4px;
 ...
 <div class="page-heading">
                    <div class="page-title">
                        <div class="row">
                            <div class="col-12 col-md-6 order-md-1 order-last">
                                <h3>Data Obat</h3>
                                <p class="text-subtitle text-muted">Data obat terdaftar di <strong>PT. Daelim Indonesia</strong></p>
                            </div>
                    ...
                    <section class="section">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    <a href="form_add_karyawan.php" class="btn btn-primary">
                                        ...
                                        <tbody>
                                            ...
                                            if (mysqli_num_rows($result) > 0) {
                                                while ($data = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    // $tgl_masuk = date('d/m/Y', strtotime($data['tanggal_masuk']));
                                                    
                                                    // Badge status
                                                    // $badge_class = $data['status'] == 'Aktif' ? 'bg-success' : 'bg-secondary';
                                            ?>
                                                    <tr>
                                                        <td><?= $no++; ?></td>
                                                        ...
                                                        <td><?= htmlspecialchars($data['stok_minimum']); ?></td>
                                                        <td><?= htmlspecialchars($data['stok_tersedia']); ?></td>
                                                        <td><?= htmlspecialchars($data['harga_satuan']); ?></td>
                                                        <td><?= htmlspecialchars($data['tanggal_kadaluarsa']); ?></td>
                                                        <td><?= htmlspecialchars($data['updated_at']); ?></td>
                                                        <td>
                                                            <div class="btn-group-action">
                                                                <a href="edit.php?id=<?= $data['kode_obat']; ?>" 
                                                                   class="btn btn-warning btn-sm" 
                                                                    title="Edit">
                                                                    <i class="bi bi-pencil"></i> Edit
                                                                </a>
                                                                <a href="delete.php?id=<?= $data['kode_obat']; ?>" 
                                                                   class="btn btn-danger btn-sm" 
                                                                   onclick="return confirm('Yakin hapus data obat <?= htmlspecialchars($data['nama_obat']); ?>?')"
                                                                   title="Hapus">
                                            ...
                                            <?php
                                                ...
                                                echo '<tr><td colspan="11" class="text-center">Belum ada data obat</td></tr>';
                                            }
                                            ?>
                                        </tbody>
                                    </table>
